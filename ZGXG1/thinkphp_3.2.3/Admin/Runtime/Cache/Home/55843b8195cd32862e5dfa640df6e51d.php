...
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" type="text/css" href="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/Public/admin/css/min.css">
    <style type="text/css">
        .estrela {
        ...
        h1{font-family: "YouYuan";font-size: 50px;color: white;margin-left: 280px;margin-top: 100px}
    </style>
    <style type="text/css" id="29013943366"></style>
    <link rel="stylesheet" href="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/Public/admin/css/layer.css" id="layui_layer_skinlayercss">
    <link rel="stylesheet" href="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/Public/admin/css/style.20170605.css" id="layui_layer_skinomstyle20170605css">
</head>
<body>
...
<div class="screens" id="screens">
    ...
    <div class="first-screen" style="height: 654px;">
        <div class="bg" id="skin-bg">
            ...
            <img src="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/Public/admin/img/login_screen1_bg.jpg" style="width: 1910px; height: 1074.38px; margin-left: 0px; top: -420.375px; left: 0px; position: inherit;">
        </div>
        ...
        <div class="content">
                ...
                <svg width="1352" height="522">
                    ...
                    <defs>
                        <pattern id="networkBg" patternUnits="userSpaceOnUse" width="100%" height="100%">
                            <image xmlns:xlink="http:http://www.w3.org/1999/xlink" xlink:href="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/Public/admin/img/network-3.0.png" x="0" y="0" width="1352" height="522"></image>
                        </pattern>
            ...
            <h1>朝 过 夕 改 后 台 管 理 系 统</h1>
            <div class="login-panel" style="margin-top: 200px;margin-right: 500px ">
                <form class="form-control " method="post" action="<?php echo U('index/login');?>">
                    ...
                    <div class="login-submit">
                        <button type="submit" class="btnLogin btn btn-primary">登录</button>
                    </div>
                </form>
            </div>
        </div>
