...
<html>
	...
	<div class="main-layout" id='main-layout'>
		...
		<div class="wrap-container">
			<form class="layui-form" style="width: 90%;padding-top: 20px;" method="post" action="doadd1">
				<div class="layui-form-item">
					<label class="layui-form-label">ID：</label>
					<div class="layui-input-block">
						<input required lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input" type="text" name="uid" >
					</div>
