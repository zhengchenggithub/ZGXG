...
<div class="container layout layout-margin-top">
    <div class="row">
            ...
            <div class="content">
                ...
                <div id="dis4" style="display: none">
                    <div class="layui-row">
                        ...
                        <div class="layui-col-md2 layui-col-md-offset8" style="margin-top: 20px">

                            <button type="button" class="layui-btn layui-btn-normal" onclick="onAddBtn()"><i class="layui-icon">&#xe654;新增课程</i></button>
                        </div>
                    </div>
                    <hr class="layui-bg-green">

                    <form class="layui-form" enctype="multipart/form-data" method="post" action="<?php echo U('personal/uploadvideo');?>">
                        <div class="layui-form-item" style="display: none">
                            <label class="layui-form-label">ID</label>
                            <div class="layui-input-block">
                                <input type="text" name="cid" required  lay-verify="required" class="layui-input" value="$data.cid">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">视频名</label>
                            <div class="layui-input-block">
                                <input type="text" name="vname" required  lay-verify="required" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">选择课程</label>
                            <div class="layui-input-block">
                                <select name="ccid" lay-verify="required" lay-search>
                                    <?php if(is_array($coursesname)): $i = 0; $__LIST__ = $coursesname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coursesname): $mod = ($i % 2 );++$i;?><option value="<?php echo ($coursesname["cid"]); ?>"><?php echo ($coursesname["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn" lay-submit>立即上传</button>
                            </div>
                        </div>
                    </form>
        ...
        <div id="add" style="display: none;">
            <form class="layui-form" method="post" enctype="multipart/form-data" action="<?php echo U('personal/addcourses');?>">
                <div class="layui-form-item">
                    <label class="layui-form-label">课程名称</label>
                    <input class="layui-input layui-input-inline" type="text" name="cname" style="width: 400px">
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">选择专业</label>
                    <div class="layui-input-inline">
                        <select name="mid" lay-verify="required" lay-search>
                            <?php if(is_array($majorname)): $i = 0; $__LIST__ = $majorname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$majorname): $mod = ($i % 2 );++$i;?><option value="<?php echo ($majorname["mid"]); ?>"><?php echo ($majorname["mname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                            <textarea placeholder="请输入内容" class="layui-textarea" name="cdescribe" style="width: 400px"></textarea>
                    </div>
                </div>
                <div id="button_group" class="layui-form-item" style="margin-left: 100px">
        ...
        <div class="col-md-3 layout-side">
                                    ...
                                    <div class="row">
                                        <div id="crop-avatar" class="col-md-6">
                                            <div class="avatar-view" title="Change Logo Picture">
                                                <img id="img1" src="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/img/<?php echo ($data1["uphoto"]); ?>" alt="Logo">
                                            </div>
                                        </div>
            ...
            <div class="sidebox">
                <div id=main class="sidebox-body course-content side-list-body active" style="text-align: center">
                    ...
                    <a onclick="opens(4)" href="javascript:void(0)" class="text" style="font-size: 20px"><i class="layui-icon" style="font-size: 20px">&#xe62f;</i>上传视频</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use(['form','layedit','laydate','upload'], function(){
        ...
        upload.render({
            elem: '#test8'
            ,url: "<?php echo U('personal/uploadvideo');?>"
            ,auto: false
            ,accept: 'video'
        });
        //自定义验证规则
