            ...
            <ul class="nav navbar-nav">
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="" href="<?php echo U('Onlinecourses/index');?>" >在线课程</a></li>
                        <li><a class="" href="#">课堂视频</a></li>
                    </ul>
                </li>
                <li class="">
                    <a href="#">路径</a>
            ...
            <div class="content">
                <div class="row">
                    <?php if(is_array($data)): foreach($data as $key=>$data): ?><div class="col-sm-6">
                        <a href="<?php echo U('Chapter/index','oid='.$data['oid']);?>">
                            <div class="path-item">
                                <div class="col-xs-5 col-md-4  path-img">
                                    <img src="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/img/<?php echo ($data["ocphoto"]); ?>">
                                </div>
                                <div class="col-xs-7 col-md-8">
                                    <div class="path-name"><?php echo ($data["ocname"]); ?></div>
                                ...
                                <div class="desc-layer">
                                    <div class="center"><?php echo ($data["ocdescribe"]); ?></div>
                                </div>
                            </div>
                        </a>
