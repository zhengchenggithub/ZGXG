...
<div class="main-layout" id='main-layout'>
	...
	<div class="main-layout-container">
		...
		<div class="page-content-wrap">
			<form class="layui-form" action="serach1">
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						<input type="text" name="mid" required lay-verify="required" placeholder="请输入账号" autocomplete="off" class="layui-input">
					</div>
				...
				<div class="layui-form" id="table-list">
					<table class="layui-table" lay-skin="line" >
						...
						<?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<a href="<?php echo U('kecheng/edit1','mid='.$vo['mid']);?>" class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
									<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" onclick="showDel('<?php echo ($vo["mname"]); ?>','<?php echo ($vo["mid"]); ?>')">删除</a>
								</td>
				...
				<div class="layui-form" id="table-list1">
					<table class="layui-table" lay-skin="line" >
						...
						<?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<!--<td><?php echo ($vo["utype"]); ?></td>-->
								<td>
									<a href="edit1.html?mid=<?php echo ($vo["mid"]); ?>" class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
									<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" onclick="showDel('<?php echo ($vo["mname"]); ?>','<?php echo ($vo["mid"]); ?>')">删除</a>
								</td>
							</tr><?php endforeach; endif; else: echo "" ;endif; ?>
						</tbody>
...
<script>
    ...
    //
    // });
    function showDel(mname, Mid) {
        var layer = layui.layer;


        layer.confirm("确认删除"+mname+"?", {
            btn: ['确认','取消'] //按钮
        }, function(){
            location.href = 'delete1?mid='+Mid;
        });
    }
</script>
<script>
            ...
            jump:function (obj,first) {
                ...
                if(!first){
                    if(location.href.indexOf('currpage')==-1) {
                        location.href="danyelist/currpage/"+obj.curr+'.html';
                    }else {
