...
<div class="container layout layout-margin-top">
    <div class="content">
        ...
        <div style="width: 650px; position: relative; left:25%;">
            <form class="layui-form" method="post" action="<?php echo U('register/register');?>">
                <div class="layui-form-item">
                    <label class="layui-form-label">手机号</label>
                    <div class="layui-inline">
                        <input id="phone" type="text" name="uaccount" required  lay-verify="required" placeholder="请输入登陆账户" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <input id="rpwd" type="text" name="yanzhengma" placeholder="验证码" autocomplete="off" class="layui-input">
                        <button type="button" class="layui-btn" rel="external nofollow" id="butphone">点击获取短信验证码</button>
                    </div>
                </div>
...
<script type="text/javascript" src="/phpText/ZGXG/ZGXG1/thinkphp_3.2.3/Public/app/jquery.min.js"></script>
...
<script type="text/javascript">
    $('#butphone').click(function(){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo U('register/smsbao');?>",//传递的方法
            data:
                {
                    phone1: phone
                },
