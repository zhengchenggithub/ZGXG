            ...
            <div class="content">
                <div class="content">
                    <div class="row course-cates">
                        ...
                        <div class="col-md-11 course-cates-content zzx">
                            <a class="" href="<?php echo U('Courses/index');?>">全部</a>
                            <a class="" href="<?php echo U('courses/index1');?>">在线</a>
                            <a class="active" href="<?php echo U('courses/index2');?>">课堂</a>
                        </div>
                    </div>
                    <div class="row course-cates">
                        <div class="col-md-1 course-cates-title">专业：</div>
                        <div class="col-md-11 course-cates-content">
                            <a class="" href="<?php echo U('courses/index2');?>">全部</a>
                            <?php if(is_array($data2)): $k = 0; $__LIST__ = $data2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data2): $mod = ($k % 2 );++$k;?><a class="" href="<?php echo U('courses/index2','mid='.$data2['mid']);?>"><?php echo ($data2["mname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                </div>
