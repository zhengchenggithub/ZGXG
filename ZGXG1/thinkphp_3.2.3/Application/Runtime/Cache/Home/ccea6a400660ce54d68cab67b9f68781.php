...
<div class="container layout layout-margin-top">
        <div class="content">
            ...
            <form class="layui-form" method="post" action="<?php echo U('login/login');?>">
                <div class="layui-form-item">
                    <label class="layui-form-label">账户</label>
                    <div class="layui-input-block">
                        <input type="text" name="uaccount" required  lay-verify="required" placeholder="请输入账户" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <a class="layui-btn" href="<?php echo U('index/register');?>" lay-filter="formDemo">前往注册</a>
                    </div>
                </div>
            </form>
            </div>
