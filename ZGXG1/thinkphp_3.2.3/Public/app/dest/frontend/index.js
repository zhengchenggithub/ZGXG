...
//                                                         for (; ;) switch (t.prev = t.next) {
//                                                             case 0:
//                                                                 return n = this.$signinForm.attr("action"),
//                                                                     r = this.$signinForm.find('[name="remember"]'),
//                                                                     e = {
...
//                                                                     },
//                                                                 e.login || this.errMsg("请输入邮箱"),
//                                                                 e.password || this.errMsg("请输入密码"),
//                                                                     t.next = 7,
//                                                                     this.ajax(n, e);
//                                                             case 7:
//                                                             case "end":
...
//                                                         for (; ;) switch (t.prev = t.next) {
//                                                             case 0:
//                                                                 return n = this.$signupForm.attr("action"),
//                                                                     r = {
...
//                                                                     },
//                                                                 r.email || this.errMsg("请输入邮箱"),
//                                                                 r.password || this.errMsg("请输入密码"),
//                                                                 r.captcha_v || this.errMsg("请输入验证码"),
//                                                                     t.next = 7,
//                                                                     this.ajax(n, r);
//                                                             case 7:
//                                                             case "end":
