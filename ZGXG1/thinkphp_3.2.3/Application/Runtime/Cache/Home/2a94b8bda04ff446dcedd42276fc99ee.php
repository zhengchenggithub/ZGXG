    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="header-navbar-collapse">
            ...
            <div class="navbar-right btns">
                <a class="btn btn-default navbar-btn sign-in" data-sign="signin" href="<?php echo U('index/login');?>" data-toggle="modal">登录</a>
                <a class="btn btn-default navbar-btn sign-up" data-sign="signup" href="<?php echo U('index/register');?>" data-toggle="modal">注册</a>
            </div>
        </div>
    </div>
</nav>
                                    ...
                                    <div>
                                        ...
                                        <div class="list-show">
                                            <div class="knowledge-system">
                                                ...
                                                <div>
                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >前端基础</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">HTML</a>
                                                            <a href="<?php echo U('index/login');?>">CSS</a>
                                                            <a href="<?php echo U('index/login');?>">JavaScript</a>
                                                            <a href="<?php echo U('index/login');?>">HTML5</a>
                                                            <a href="<?php echo U('index/login');?>">CSS3</a>
                                                            <a href="<?php echo U('index/login');?>">技术前瞻</a>
                                                        </dd>
                                                    </dl>

                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >前端进阶</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">Typescript</a>
                                                            <a href="<?php echo U('index/login');?>">前端安全</a>
                                                            <a href="<?php echo U('index/login');?>">项目实战</a>
                                                        </dd>
                                                    </dl>

                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >前端框架</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">jQuery</a>
                                                            <a href="<?php echo U('index/login');?>">jQuery UI</a>
                                                            <a href="<?php echo U('index/login');?>">jQuery Mobile</a>
                                                            <a href="<?php echo U('index/login');?>">Ext JS</a>
                                                            <a href="<?php echo U('index/login');?>">AngularJS</a>
                                                            <a href="<?php echo U('index/login');?>">ReactJS</a>
                                                            <a href="<?php echo U('index/login');?>">Bootstrap</a>
                                                            <a href="<?php echo U('index/login');?>">React Native</a>
                                                            <a href="<?php echo U('index/login');?>">Backbone</a>
                                                            <a href="<?php echo U('index/login');?>">Three.js</a>
                                                            <a href="<?php echo U('index/login');?>">MooTools</a>
                                                            <a href="<?php echo U('index/login');?>">Compass</a>
                                                        </dd>
                                                    </dl>

                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >HTML5游戏</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">Canvas</a>
                                                            <a href="<?php echo U('index/login');?>">SVG</a>
                                                            <a href="<?php echo U('index/login');?>">WebGL</a>
                                                            <a href="<?php echo U('index/login');?>">Cocos2d-js</a>
                                                            <a href="<?php echo U('index/login');?>">CreateJS</a>
                                                            <a href="<?php echo U('index/login');?>">Flash</a>
                                                            <a href="<?php echo U('index/login');?>">Unreal</a>
                                                            <a href="<?php echo U('index/login');?>">Egret</a>
                                                            <a href="<?php echo U('index/login');?>">Phaser</a>
                                                        </dd>
                                                    </dl>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="list-show">
                                            <div class="knowledge-system">
                                                ...
                                                <div>
                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >应用开发</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">Android</a>
                                                            <a href="<?php echo U('index/login');?>">iOS</a>
                                                        </dd>
                                                    </dl>

                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >游戏开发</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">Cocos</a>
                                                            <a href="<?php echo U('index/login');?>">Unity3D</a>
                                                            <a href="<?php echo U('index/login');?>">SpriteKit 2D</a>
                                                            <a href="<?php echo U('index/login');?>">Unreal</a>
                                                        </dd>
                                                    </dl>

                                                    <dl>
                                                        <dt><a href="<?php echo U('index/login');?>" >常用框架</a></dt>
                                                        <dd class="cf">
                                                            <a href="<?php echo U('index/login');?>">Cordova</a>
                                                            <a href="<?php echo U('index/login');?>">React Native</a>
                                                        </dd>
                                                    </dl>
